...
export default function PetCard({ pet, onSwipeLeft, onSwipeRight, onSwipeUp }: PetCardProps) {
  // Animation values
      ...
      onPanResponderRelease: (_, gesture) => {
        ...
        if (gesture.dx > 120) {
          Animated.spring(position, {
            toValue: { x: Layout.window.width + 100, y: gesture.dy },
        ...
        // Swipe up (view details)
          ...
          Animated.spring(position, {
            toValue: { x: gesture.dx, y: -Layout.window.height - 100 },
            useNativeDriver: Platform.OS !== 'web',
          }).start(() => {
            onSwipeUp();
          });
